              ...
              <div className="bg-amber-50 bg-opacity-95 min-h-[600px] p-12 relative shadow-inner">
                <div className="relative z-10">
                  ...
                  {[
                    ...
                    { name: '🛍 Cocobe', desc: ' Site vitrine e-commerce développé avec WordPress et WooCommerce, permettant la présentation de produits, la gestion des commandes et des paiements en ligne. Conçu pour offrir une expérience utilisateur fluide, avec une interface moderne et une navigation optimisée.', tags: ['WordPress', 'CMS', 'WooCommerce', 'UI/UX'], link: 'https://cocobe-mg.com' },
